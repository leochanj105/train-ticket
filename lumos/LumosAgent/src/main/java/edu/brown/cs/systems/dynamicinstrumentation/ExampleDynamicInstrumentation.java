...
public class ExampleDynamicInstrumentation {
    ...
    public static final String className = "edu.brown.cs.systems.dynamicinstrumentation.ExampleDynamicInstrumentation";
    ...
    public static class ExperimentModification implements DynamicModification {
        ...
        public void apply(ClassPool pool) throws NotFoundException, CannotCompileException {
            pool.get(className).getDeclaredMethod(methodName).insertBefore("edu.brown.cs.systems.dynamicinstrumentation.ExampleDynamicInstrumentation.methodBegin(\""+expId+"\");");
            pool.get(className).getDeclaredMethod(methodName).insertAfter("edu.brown.cs.systems.dynamicinstrumentation.ExampleDynamicInstrumentation.methodEnd(\""+expId+"\");");
        }
